...
int endWith(string s, string sub)
{
...
YOLO ::YOLO(Net_config config)
{
    ...
    ifstream ifs("/Data2/zengsheng/dpl_works/yolov5-cpp/opencv/class.names");
    string line;
    while (getline(ifs, line))
        this->class_names.push_back(line);
    this->num_class = class_names.size();

    if (endWith(config.modelpath, "6.onnx"))
    {
...
int main()
{
    Net_config yolo_nets = { 0.3, 0.5, 0.3, "/Data2/zengsheng/dpl_works/yolov5-cpp/opencv/weights/yolov5s.onnx" };
	YOLO yolo_model(yolo_nets);
	string imgpath = "/Data2/zengsheng/dpl_works/yolov5-cpp/opencv/images/bus.jpg";
	Mat srcimg = imread(imgpath);
	yolo_model.detect(srcimg);
	imwrite("/Data2/zengsheng/dpl_works/yolov5-cpp/opencv/result.jpg", srcimg);
